...
#
# For eg,
# ARTIFACT = "charmed-spark_3.5.4_amd64.tar" 			TAG = "3.5.4"			DISPLAY_NAME = "ghcr.io/canonical/charmed-spark"
# or,
# ARTIFACT = "charmed-spark-jupyterlab_3.5.4_amd64.tar"	TAG = "3.5.4-4.0.11"	DISPLAY_NAME = "ghcr.io/canonical/charmed-spark-jupyterlab"
# or,
# ARTIFACT = "charmed-spark-kyuubi_3.5.4_amd64.tar"		TAG = "3.5.4-1.9.0"		DISPLAY_NAME = "ghcr.io/canonical/charmed-spark-kyuubi"
# or, 
# ARTIFACT = "charmed-spark_gpu_3.5.4_amd64.tar" 		TAG = "3.5.4-24.04.1"			DISPLAY_NAME = "ghcr.io/canonical/charmed-spark-gpu"
...
# 
# ROCK_FILE => charmed-spark_3.5.4_amd64.rock
#
...
#
# eg, ARTIFACT => charmed-spark_3.5.4_amd64.tar
build: $(ARTIFACT)
