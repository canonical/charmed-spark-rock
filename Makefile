...
#
# For eg,
# ARTIFACT = "charmed-spark_3.5.5_amd64.tar" 			TAG = "3.5.5"			DISPLAY_NAME = "ghcr.io/canonical/charmed-spark"
# or,
# ARTIFACT = "charmed-spark-jupyterlab_3.5.5_amd64.tar"	TAG = "3.5.5-4.0.11"	DISPLAY_NAME = "ghcr.io/canonical/charmed-spark-jupyterlab"
# or,
# ARTIFACT = "charmed-spark-kyuubi_3.5.5_amd64.tar"		TAG = "3.5.5-1.10.2"		DISPLAY_NAME = "ghcr.io/canonical/charmed-spark-kyuubi"
# or, 
# ARTIFACT = "charmed-spark_gpu_3.5.5_amd64.tar" 		TAG = "3.5.5-24.04.1"			DISPLAY_NAME = "ghcr.io/canonical/charmed-spark-gpu"
...
# 
# ROCK_FILE => charmed-spark_3.5.5_amd64.rock
#
...
#
# eg, ARTIFACT => charmed-spark_3.5.5_amd64.tar
build: $(ARTIFACT)
